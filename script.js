...
const baseNutricional = [
    { id: "avena", nombre: "Heno de avena", pt: 8.0, fdn: 63.0, precio: 0.60, inicial: 30.00 },
    { id: "haba", nombre: "Broza de haba", pt: 9.6, fdn: 62.8, precio: 0.10, inicial: 5.00 },
    { id: "maiz", nombre: "Maíz amarillo", pt: 9.8, fdn: 10.8, precio: 1.00, inicial: 16.67 },
    { id: "afrecho", nombre: "Afrecho de trigo (SPT)", pt: 15.0, fdn: 42.8, precio: 1.30, inicial: 16.50 },
    { id: "polvillo", nombre: "Polvillo de arroz", pt: 14.4, fdn: 33.0, precio: 1.00, inicial: 15.83 },
    { id: "soya", nombre: "Torta de soya", pt: 44.0, fdn: 14.9, precio: 2.15, inicial: 15.00 },
    { id: "sal", nombre: "Sal común", pt: 0.0, fdn: 0.0, precio: 0.20, inicial: 0.50 },
    { id: "rocsalfos", nombre: "Rocsalfos", pt: 0.0, fdn: 0.0, precio: 2.10, inicial: 0.50 },
    { id: "soyaintegral", nombre: "Harina integral de soya", pt: 38.0, fdn: 22.0, precio: 2.22, inicial: 5}
];
